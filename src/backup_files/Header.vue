...
<header class="header">
    ...
    <div class="header-actions">
      ...
      <div class="header-brand">
        ...
        <!-- HEADER BRAND TEXT -->
        <h1 class="header-brand-text">EOSIO</h1>
        <!-- /HEADER BRAND TEXT -->
      </div>
      <!-- /HEADER BRAND -->
    </div>
      ...
      <nav class="navigation">
        ...
        <ul class="menu-main">
          ...
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="/dashboard">Home</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <!-- /MENU MAIN ITEM -->
          ...
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="#" @click="clicked($event)">Stake Void</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <!-- /MENU MAIN ITEM -->
          ...
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="/reclaim">Reclaim</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="/account">Account</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <!-- /MENU MAIN ITEM -->
          ...
          <!-- <li class="menu-main-item">
            ...
            <ul class="menu-main">
              <li class="menu-main-item">
                <a class="menu-main-item-link" href="#" @click="logout">Logout</a>
              </li>
    ...
    <div class="header-actions search-bar" style="position: relative;">
      ...
      <div class="interactive-input dark">
        <input type="text" id="search-main" name="search_main" placeholder="Search here.." @keyup="searchAsset($event)">
    ...
    <div class="header-actions">
      ...
      <div class="action-list dark">
        ...
        <div class="action-list-item-wrap" style="position: relative;">
          <!-- ACTION LIST ITEM -->
          <!-- DROPDOWN BOX -->
          <div class="dropdown-box no-padding-bottom header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
        
            <!-- DROPDOWN BOX LIST -->
            <div class="dropdown-box-list scroll-small no-hover" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
              <!-- DROPDOWN BOX LIST ITEM -->
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid" style="background: url(&quot;img/marketplace/items/01.jpg&quot;) center center / cover no-repeat;">
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid" style="background: url(&quot;img/marketplace/items/11.jpg&quot;) center center / cover no-repeat;">
                      <img src="img/marketplace/items/11.jpg" alt="item-11" style="display: none;">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid" style="background: url(&quot;img/marketplace/items/10.jpg&quot;) center center / cover no-repeat;">
                      <img src="img/marketplace/items/10.jpg" alt="item-10" style="display: none;">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="cart-item-preview">
                  ...
                  <a class="cart-item-preview-image" href="marketplace-product.html">
                    <!-- PICTURE -->
                    <figure class="picture medium round liquid" style="background: url(&quot;img/marketplace/items/04.jpg&quot;) center center / cover no-repeat;">
                      <img src="img/marketplace/items/04.jpg" alt="item-04" style="display: none;">
                    </figure>
                    <!-- /PICTURE -->
                  </a>
                  <!-- /CART ITEM PREVIEW IMAGE -->
              ...
              <!-- /DROPDOWN BOX LIST ITEM -->
            </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 360px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 227px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
            <!-- /DROPDOWN BOX LIST -->
        ...
        <div class="action-list-item-wrap" style="position: relative;">
          ...
          <!-- DROPDOWN BOX -->
          <div class="dropdown-box header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
            <!-- DROPDOWN BOX HEADER -->
            ...
            <div class="dropdown-box-list no-hover" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                ...
                <div class="user-status request">
                  ...
                  <a class="user-status-avatar" href="profile-timeline.html">
                    ...
                    <div class="user-avatar small no-outline">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-30-32" data-src="img/avatar/16.jpg" style="width: 30px; height: 32px; position: relative;"><canvas width="30" height="32" style="position: absolute; top: 0px; left: 0px;"></canvas></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
                ...
                <div class="user-status request">
                  ...
                  <a class="user-status-avatar" href="profile-timeline.html">
                    ...
                    <div class="user-avatar small no-outline">
                      ...
                      <div class="user-avatar-content">
                        <!-- HEXAGON -->
                        <div class="hexagon-image-30-32" data-src="img/avatar/11.jpg" style="width: 30px; height: 32px; position: relative;"><canvas width="30" height="32" style="position: absolute; top: 0px; left: 0px;"></canvas></div>
                        <!-- /HEXAGON -->
                      </div>
                      <!-- /USER AVATAR CONTENT -->
              ...
              <!-- /DROPDOWN BOX LIST ITEM -->
            </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 228px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; display: none;"></div></div></div>
            <!-- /DROPDOWN BOX LIST -->
        ...
        <div class="action-list-item-wrap" style="position: relative;">
          ...
          <div class="dropdown-box header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
            ...
            <!-- DROPDOWN BOX LIST -->
            <div class="dropdown-box-list medium" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
              <!-- DROPDOWN BOX LIST ITEM -->
              ...
              <!-- /DROPDOWN BOX LIST ITEM -->
            </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 504px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 350px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
            <!-- /DROPDOWN BOX LIST -->
        ...
        <div class="action-list-item-wrap" style="position: relative;">
          <!-- ACTION LIST ITEM -->
          <div class="action-list-item unread header-dropdown-trigger" @click="logout">
            <!-- ACTION LIST ITEM ICON -->
            <!-- <svg class="action-list-item-icon icon-notification">
              <use xlink:href="#svg-notification">Logout</use>
            </svg> -->
          ...
          <div class="dropdown-box header-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
            ...
            <!-- DROPDOWN BOX LIST -->
            <div class="dropdown-box-list" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
              <!-- DROPDOWN BOX LIST ITEM -->
      ...
      <div class="action-item-wrap" style="position: relative;">
        ...
        <!-- DROPDOWN NAVIGATION -->
        <div class="dropdown-navigation header-settings-dropdown" style="position: absolute; z-index: 9999; top: 64px; right: 22px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;">
...
export default {
 ...
 methods:{
   clicked(ev){
     this.$emit("transfer-modal-up",ev)
   },
    logout: function() {
      router.push('/login')
    },
    searchAsset(event){
      this.emitter.emit("search-asset", event.target.value);
      // this.$emit("searchAsset",event.target.value);
      // EventBus.$emit('searchAsset', event.target.value)
    }
 }
}
</script>
