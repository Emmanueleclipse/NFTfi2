  ...
  <header class="header">
    ...
    <div class="header-actions">
      ...
      <div class="header-brand">
        ...
        <div class="logo">
          <!-- ICON LOGO VIKINGER -->
          <!-- <span class="logo-first-text">WHEN</span><span class="logo-last-text">STAKING</span> -->
          <router-link to="/">
            <img class="dashboard-logo" src="@/assets/img/landing/whenstaking_white.png" alt="Logo" width="180" height="35"/>
          </router-link>
          <!-- /ICON LOGO VIKINGER -->
        </div>
        <!-- /LOGO -->
    ...
    <div class="header-actions">
      ...
      <nav class="navigation">
        ...
        <ul class="menu-main">
          ...
          <!-- MENU MAIN ITEM -->
          <!-- <li class="menu-main-item">
            <a class="menu-main-item-link" href="#" @click="clicked($event)"
              >Stake Void</a
            >
          </li> -->
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
            <a class="menu-main-item-link" href="/stakes">Stakes</a>
            <!-- /MENU MAIN ITEM LINK -->
          </li>
          <li class="menu-main-item">
            <!-- MENU MAIN ITEM LINK -->
          ...
          <li class="menu-main-item">
            <router-link class="menu-main-item-link" to="/contact-us">Contact Us</router-link>
          </li>
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" href="profile-timeline.html">
            ...
            <div class="user-status notification">
              ...
              <p class="user-status-title">
                <span class="bold">Neko Bebop</span>
              </p>
              <!-- /USER STATUS TITLE -->
          ...
          <a class="dropdown-box-list-item" href="profile-timeline.html">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Tim Rogers</span>
              </p>
              <!-- /USER STATUS TITLE -->
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" href="group-timeline.html">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Cosplayers of the World</span>
              </p>
              <!-- /USER STATUS TITLE -->
          ...
          <a class="dropdown-box-list-item" href="marketplace-product.html">
            ...
            <div class="user-status no-padding-top">
              ...
              <div class="user-status-avatar">
                <!-- PICTURE -->
                <figure
                  class="picture small round liquid"
                  style='background: url("img/marketplace/items/07.jpg") center center / cover no-repeat;'
                >
                  <img
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Mercenaries White Frame</span>
              </p>
              <!-- /USER STATUS TITLE -->
    ...
    <div class="header-actions">
      <!-- ACTION LIST -->
      <div class="action-list dark" style="display: none">
        <!-- ACTION LIST ITEM WRAP -->
        <div class="action-list-item-wrap" style="position: relative;">
          <!-- ACTION LIST ITEM -->
          <!-- DROPDOWN BOX -->
          <div
            class="dropdown-box no-padding-bottom header-dropdown"
          ...
          >
            <!-- DROPDOWN BOX LIST -->
            <div
              class="dropdown-box-list scroll-small no-hover"
              data-simplebar="init"
            >
                      ...
                      <div class="simplebar-content" style="padding: 0px;">
                        ...
                        <div class="dropdown-box-list-item">
                          ...
                          <div class="cart-item-preview">
                            ...
                            <a
                              class="cart-item-preview-image"
                              href="marketplace-product.html"
                            >
                              <!-- PICTURE -->
                              <figure
                                class="picture medium round liquid"
                                style='background: url("img/marketplace/items/01.jpg") center center / cover no-repeat;'
                              >
                                <img
                            ...
                            <p class="cart-item-preview-title">
                              <a href="marketplace-product.html"
                                >Twitch Stream UI Pack</a
                              >
                            </p>
                            <!-- /CART ITEM PREVIEW TITLE -->

                            <!-- CART ITEM PREVIEW TEXT -->
                            <p class="cart-item-preview-text">
                              Regular License
                            </p>
                            <!-- /CART ITEM PREVIEW TEXT -->

                            <!-- CART ITEM PREVIEW PRICE -->
                            <p class="cart-item-preview-price">
                              <span class="highlighted">$</span> 12.00 x 1
                            </p>
                            <!-- /CART ITEM PREVIEW PRICE -->
                        ...
                        <div class="dropdown-box-list-item">
                          ...
                          <div class="cart-item-preview">
                            ...
                            >
                              ...
                              <figure
                                class="picture medium round liquid"
                                style='background: url("img/marketplace/items/11.jpg") center center / cover no-repeat;'
                              >
                                <img
                            ...
                            <!-- CART ITEM PREVIEW PRICE -->
                            <p class="cart-item-preview-price">
                              <span class="highlighted">$</span> 6.00 x 1
                            </p>
                            <!-- /CART ITEM PREVIEW PRICE -->
                        ...
                        <div class="dropdown-box-list-item">
                          ...
                          <div class="cart-item-preview">
                            ...
                            >
                              ...
                              <figure
                                class="picture medium round liquid"
                                style='background: url("img/marketplace/items/10.jpg") center center / cover no-repeat;'
                              >
                                <img
                            ...
                            <!-- CART ITEM PREVIEW PRICE -->
                            <p class="cart-item-preview-price">
                              <span class="highlighted">$</span> 26.00 x 1
                            </p>
                            <!-- /CART ITEM PREVIEW PRICE -->
                        ...
                        <div class="dropdown-box-list-item">
                          ...
                          <div class="cart-item-preview">
                            ...
                            >
                              ...
                              <figure
                                class="picture medium round liquid"
                                style='background: url("img/marketplace/items/04.jpg") center center / cover no-repeat;'
                              >
                                <img
                            ...
                            <!-- CART ITEM PREVIEW PRICE -->
                            <p class="cart-item-preview-price">
                              <span class="highlighted">$</span> 16.00 x 1
                            </p>
                            <!-- /CART ITEM PREVIEW PRICE -->
              ...
              >
                <div
                  class="simplebar-scrollbar"
                  style="height: 227px; transform: translate3d(0px, 0px, 0px); display: block;"
                ></div>
              </div>
            </div>
            <!-- /DROPDOWN BOX LIST -->
            ...
            <div class="cart-preview-total">
              ...
              <p class="cart-preview-total-text">
                <span class="highlighted">$</span> 60.00
              </p>
              <!-- /CART PREVIEW TOTAL TEXT -->
            </div>
            <!-- /CART PREVIEW TOTAL -->
            ...
            <div class="dropdown-box-actions">
              ...
              <div class="dropdown-box-action">
                <!-- BUTTON -->
                <a class="button secondary" href="marketplace-cart.html"
                  >Shopping Cart</a
                >
                <!-- /BUTTON -->
              </div>
              ...
              <div class="dropdown-box-action">
                <!-- BUTTON -->
                <a class="button primary" href="marketplace-checkout.html"
                  >Go to Checkout</a
                >
                <!-- /BUTTON -->
              </div>
        ...
        <div class="action-list-item-wrap" style="position: relative;">
          ...
          <!-- DROPDOWN BOX -->
          <div
            class="dropdown-box header-dropdown"
            style="position: absolute; z-index: 9999; top: 64px; right: 6px; opacity: 0; visibility: hidden; transform: translate(0px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;"
          >
            <!-- DROPDOWN BOX HEADER -->
          ...
          >
            ...
            <div class="dropdown-box-list medium" data-simplebar="init">
                      ...
                      <div class="simplebar-content" style="padding: 0px;">
                        ...
                        >
                          ...
                          <div class="user-status">
                            ...
                            <!-- USER STATUS TITLE -->
                            <p class="user-status-title">
                              <span class="bold">Sarah Diamond</span>
                            </p>
                            <!-- /USER STATUS TITLE -->
                        ...
                        >
                          ...
                          <div class="user-status">
                            ...
                            <!-- USER STATUS TITLE -->
                            <p class="user-status-title">
                              <span class="bold">James Murdock</span>
                            </p>
                            <!-- /USER STATUS TITLE -->
                        ...
                        >
                          ...
                          <div class="user-status">
                            ...
                            <!-- USER STATUS TITLE -->
                            <p class="user-status-title">
                              <span class="bold">The Green Goo</span>
                            </p>
                            <!-- /USER STATUS TITLE -->
              ...
              >
                <div
                  class="simplebar-scrollbar"
                  style="height: 350px; transform: translate3d(0px, 0px, 0px); display: block;"
                ></div>
              </div>
            </div>
            <!-- /DROPDOWN BOX LIST -->
                        ...
                        <div class="dropdown-box-list-item">
                          ...
                          <div class="user-status notification">
                            ...
                            <p class="user-status-title">
                              ...
                              >
                              posted a comment on your
                              <a class="highlighted" href="profile-photos.html"
                                >photo</a
                              >
                            </p>
                            <!-- /USER STATUS TITLE -->
      ...
      <div class="action-item-wrap" style="position: relative;">
        <!-- ACTION ITEM -->
        <div class="action-item dark header-settings-dropdown-trigger logout-button-div">
          <!-- <span class="menu-logout-text dropdown-toggle" data-toggle="dropdown"> Logout</span> -->
          <!-- ACTION ITEM ICON -->
          <span class="userAccount">{{userAccount}}</span>
          <svg class="action-item-icon icon-settings" @click="showSettingsDropdown = !showSettingsDropdown">
        ...
        <div
          ...
          class="dropdown-navigation header-settings-dropdown"
          style="width: 120px; position: absolute; z-index: 9999; top: 97px; right: 0px;  transform: translate(-30px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;"
        >
          <p class="menu-logout-text" style="margin-bottom:10px;">{{userAccount}}</p>
          <p class="text-sticker btn-transfer" @click="logout"> Logout</p>
        </div>

        <!-- DROPDOWN NAVIGATION -->
        <div
          class="dropdown-navigation header-settings-dropdown"
          style="position: absolute; z-index: 9999; top: 97px; right: 50px;  display: none; transform: translate(-70px, -40px); transition: transform 0.4s ease-in-out 0s, opacity 0.4s ease-in-out 0s, visibility 0.4s ease-in-out 0s;"
        >
          ...
          <div class="dropdown-navigation-header">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Hi Marina!</span>
              </p>
              <!-- /USER STATUS TITLE -->
          ...
          <a class="dropdown-navigation-link" href="hub-profile-info.html"
            >Profile Info</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-social.html"
            >Social &amp; Stream</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-messages.html"
            >Messages</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-profile-requests.html"
            >Friend Requests</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-info.html"
            >Account Info</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-password.html"
            >Change Password</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-account-settings.html"
            >General Settings</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-group-management.html"
            >Manage Groups</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-group-invitations.html"
            >Invitations</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-statement.html"
            >Sales Statement</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-items.html"
            >Manage Items</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link" href="hub-store-downloads.html"
            >Downloads</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
